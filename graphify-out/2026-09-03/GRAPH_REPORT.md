...
## Corpus Check
- 172 files · ~227,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1214 nodes · 2321 edges · 76 communities (59 shown, 17 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 227 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f888da46`
...
- `create_app()` --uses--> `AuthenticationError`  [INFERRED]
  backend/apps/api/src/carveo_api/main.py → backend/apps/api/src/carveo_api/auth.py
...
Cohesion: 0.06
Nodes (67): create_app(), client(), anyio, AsyncClient, fixture, ready(), test_detail_compare_and_missing_problem(), test_health_and_readiness_are_distinct() (+59 more)
...
Cohesion: 0.06
Nodes (44): ListingPage(), metadata, AppHeader(), AssistantWorkspace(), intentHref(), newId(), profile, AuthControls() (+36 more)
...
Cohesion: 0.25
Nodes (8): bodyTypes, HomePage(), makeLinks, arrayKeys, numberKeys, parseListingQuery(), positiveNumber(), listingSortSchema

### Community 5 - "settings.py"
Cohesion: 0.19
Nodes (9): do_run_migrations(), run_async_migrations(), run(), get_settings(), model_validator, Settings, MonkeyPatch, test_settings_accept_clerk_cli_secret_without_copying_it() (+1 more)

### Community 6 - "profile-provider.tsx"
Cohesion: 0.05
Nodes (45): dynamic, AppFooter(), components, $defs, operations, paths, webhooks, BrowserProfile (+37 more)
...
Cohesion: 0.08
Nodes (50): _conversation_summary(), AsyncSession, BuyerWorkspace, Conversation, ConversationCreate, ConversationSummary, ConversationTurnCreate, SavedSearch (+42 more)
...
Cohesion: 0.11
Nodes (19): MarketCharts(), fixtureCatalogue, mediaByBodyType, mediaByModel, Seed, seeds, seedSchema, AnonymousConversation (+11 more)
...
Cohesion: 0.26
Nodes (9): CarsPage(), metadata, toParams(), FilterFields(), options, MobileFilterDrawer(), SaveSearchButton(), toListingSearchParams() (+1 more)
...
Cohesion: 0.12
Nodes (13): AuthenticationError, AuthenticationUnavailableError, Exception, Protocol, RequestAuthenticator, configure_logging(), listing_query(), ListingQuery (+5 more)

### Community 66 - "BuyerWorkspaceRepository"
Cohesion: 0.05
Nodes (76): Any, AuthenticatedBuyer, add_shortlist(), append_turn(), buyer_repositories(), conversation_detail(), conversations(), create_conversation() (+68 more)
...
- **Why does `create_app()` connect `create_app` to `test_auth.py`, `main.py`, `BuyerWorkspaceRepository`, `ClerkRequestAuthenticator`, `settings.py`, `SqlAlchemyBuyerWorkspaceRepository`, `database.py`, `FakeBuyerRepository`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `BuyerWorkspaceRepository` connect `BuyerWorkspaceRepository` to `create_app`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `create_engine()` connect `database.py` to `create_app`, `test_fresh_postgres_migrates_to_head`, `settings.py`, `SqlAlchemyBuyerWorkspaceRepository`, `beat.py`?**
